 ...
 * The field(s) will be mapped when reading using {@link com.reflectiveexcel.reader.ReflectiveExcelReader#read(Class)} or,
 * when writing - using {@link com.reflectiveexcel.writer.ReflectiveExcelWriter#write(Object)}.
 */
